...
pass=QQcqxLNdL0H3
dbname=joomla
script=/home/webmaster/www/staging.liverpoolfc.ru/htdocs/modules/mod_contest/chk_game_time.sh
...
Привет, от тебя до сих пор не поступил прогноз на матч против $team.
Сделать прогноз можно по ссылке: $link
Удачи!">$mail_text
